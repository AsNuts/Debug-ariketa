		...
		do {
			...
			if (aukera == 6) {
				...
				if (aukera == 1) {
					 ...
					 * oper1 ordez emaitza jarri behar da, bestela aurreko ariketako emaitza aterako zaigu
					 */
					System.out.println("Emaitza = " + emaitza);
				} else if (aukera == 4) {
					if (oper2 == 0) {
						/**
						 * Akatsa: oper2 = 1;
						 * oper2 = 0 denean dago errorea ez oper2 = 1 denean
						 */
